...
const ManageList: React.FC<IModal> = ({
  ...
  const borderColor = useColorModeValue('#319EF6', '#f47904');
  const lightTextColor = useColorModeValue("#666666", "#DCE6EF");
  const heavyTextColor = useColorModeValue("#333333", "#F1F5F8");
  const borderColor2 = useColorModeValue("#DEE6ED", "#f47904")
  const boxColor = useColorModeValue("#F2F5F8", "#191919")
  const boxColor2 = useColorModeValue("#319EF6", "#191919")
  const backgroundColor = useColorModeValue("#ffffff", "#161616")
  const color = useColorModeValue("#319EF6", "#ffffff")
  const selectedList = useColorModeValue("#EBF6FE", "#191919")
  const switchColor = useColorModeValue("#ffffff", "#191919")
