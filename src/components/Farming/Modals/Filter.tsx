...
const Filter = ({
  ...
  const bgColor = useColorModeValue("#ffffff", "#191919");
  ...
  const filterBorderColor = useColorModeValue("#DEE5ED", "#f47904");
  const filterButton = useColorModeValue("#DEE5ED", "#f47904");
  ...
  const buttonBgColor = useColorModeValue("#DEE5ED", "#1d1d1d");
  const lastButtonColor = useColorModeValue("#FFFFFF", "#191919");
