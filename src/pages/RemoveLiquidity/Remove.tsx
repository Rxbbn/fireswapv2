...
const Remove = () => {
  ...
  const pairinformationBgColor = useColorModeValue("#FFFFFF", "#191919");
  ...
  const withdrawaButtonBgColor = useColorModeValue("#FFFFFF", "#191919");
  const hoverwithdrawaButtonBgColor = useColorModeValue("#999999", "#7599BD");
  ...
  const approvedButtonBgColor = useColorModeValue("#FFFFFF", "#191919");
